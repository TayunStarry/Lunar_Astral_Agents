...
var (
	...
	DiffusionModel = flag.String("diffusion-model", *LocalDir+"/models/z_image_turbo-Q4_K.gguf", "扩散模型路径，用于图像生成")
	// VariationalModel VAE模型路径，用于图像编码与解码
	VariationalModel = flag.String("variational-model", *LocalDir+"/models/diffusion_pytorch_model.safetensors", "VAE模型路径, 用于图像编码与解码")
	// PromptRefineModel 提示精炼模型路径，用于优化图像提示词与负面提示词
	PromptRefineModel = flag.String("prompt_refine-model", *LocalDir+"/models/Qwen3-4B-Instruct-2507-Q4_K_M.gguf", "提示精炼模型路径，用于优化图像提示词与负面提示词")
