...
var (
	...
	WebViewHeight = flag.Int("webview-height", 615, "webview 窗口高度")
	// WebViewMinWidth webview 窗口最小宽度
	WebViewMinWidth = flag.Int("webview-min-width", 300, "webview 窗口最小宽度")
	// WebViewMinHeight webview 窗口最小高度
	WebViewMinHeight = flag.Int("webview-min-height", 520, "webview 窗口最小高度")
